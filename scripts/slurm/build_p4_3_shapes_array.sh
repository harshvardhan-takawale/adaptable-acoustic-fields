...
# Usage:  sbatch --array=0-13 scripts/slurm/build_p4_3_shapes_array.sh
#SBATCH --job-name=aaf_p4_3_build
...
python scripts/build_p4_2_shapes.py \
    --manifest configs/sweeps_2d_mat/p4_3_shapes_manifest.json \
