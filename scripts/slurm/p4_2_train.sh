#!/bin/bash
# P4-2 training (Task A T-geo+m, Stage 2 notch-family arms).
# Usage:  sbatch scripts/slurm/p4_1_train.sh configs/sweep_2d_mat/P4_1_Tgeo.yaml
#         OUT_ROOT=outputs/p4_2/taskA sbatch scripts/slurm/p4_1_train.sh <yaml>
#
...
OUT="${OUT_ROOT:-outputs/p4_2/taskA}/${RUN_ID}"
