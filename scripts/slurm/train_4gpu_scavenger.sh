...
#SBATCH --job-name=aaf_p3_train_scav
...
export NCCL_P2P_DISABLE=1   # avoid P2P-topology init hangs on heterogeneous scavenger nodes
export NCCL_IB_DISABLE=1    # use TCP instead of InfiniBand (compatible, slightly slower)
