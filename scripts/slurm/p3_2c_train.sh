#!/bin/bash
# P3-2c training (single GPU), one arm per job. Usage:
...
#   OUT_ROOT         so the four arms land under outputs/p3_2c/ rather than outputs/p3_2/.
#SBATCH --job-name=aaf_p3_2c_train
...
OUT="${OUT_ROOT:-outputs/p3_2c}/${RUN_ID}"
mkdir -p "${OUT}"
